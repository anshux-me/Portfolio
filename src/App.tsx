    ...
    <main className="container">
      ...
      <nav className={`social-navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="social-icons-container">
          <a href="https://github.com/anshux-me" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-icon" title="GitHub">
          ...
          <a href="https://www.linkedin.com/in/anshuxme/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-icon" title="LinkedIn">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
